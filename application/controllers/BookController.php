	...
	**/
	public function getBookList()
	{
		...
		foreach ($list as $books) {
			...
			$btn = $books->book_status == 0 ? 'disabled' : 'onclick="return_books('."'".$books->id."'".')"';
			...
			$row[] = '<a class="btn btn-sm btn-primary" href="javascript:void(0)" title="Edit" onclick="edit_books('."'".$books->id."'".')"><i class="glyphicon glyphicon-pencil"></i></a>
				  ...
				  <a class="btn btn-sm btn-danger" href="javascript:void(0)" title="Return book" '.$btn.'><i class="glyphicon glyphicon-download-alt"></i></a>';
